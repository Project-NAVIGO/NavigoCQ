...
export function SignupForm({ onSwitchToLogin, onClose, onSuccess }: SignupFormProps) {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      console.log("[v0] Google sign-in error:", err)
    } finally {
  ...
  return (
    <Card className="w-full max-w-md mx-auto border-border/50 shadow-lg">
      <CardHeader className="text-center space-y-2">
        ...
        <CardDescription>Create your account and start exploring campus</CardDescription>
      </CardHeader>
